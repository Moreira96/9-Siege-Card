...
//        preenchedados();
    ...
    public boolean move( int quanto, String qual)
    {
        ...
        if(qual.toLowerCase().equals("wall"))
       {
            ...
            if(qual.toLowerCase().equals("morale"))
            {
...
//System.out.println("index "+ index);
                ...
                for( int i = 0 ; i< tunel.length; i++)
                {
                    ...
                    if(qual.toLowerCase().equals("raid"))
                 {
               index= 0 ; 
             //  int flag=0 ;
...
//System.out.println("index "+ index);
    ...
    public int getPosicao (String qual)
    {
            ...
            for( int i =  0 ; i  < wall.length; i++)
        {
            ...
            System.out.println("WALL INDEX : .>" + index);
            return index;  
        }
        else
        if(qual.toLowerCase().equals("morale"))
            ...
            for( int i =  0 ; i  < morale.length; i++)
        {
            ...
            System.out.println("MORALE INDEX : .>" + index);
            return index;  
        }
        else
        if(qual.toLowerCase().equals("supplie"))
        {
           int index  = 0;
            for( int i =  0 ; i  < supplie.length; i++)
        {
            ...
            System.out.println("SUPPLIE INDEX : .>" + index);
            return index;  
        }
        else
            if(qual.toLowerCase().equals("tunnel"))
            {
            int  index = 0;
        for(int i = 0; i < tunel.length; i++){
            if(tunel[i] == 1)
            ...
            System.out.println("TUNNEL INDEX : .>" + index);
        return index;
            }
            ...
            for( int i =  0 ; i  < raid.length; i++)
        {
            ...
            System.out.println("RAID INDEX : .>" + index);
            return index ; 
