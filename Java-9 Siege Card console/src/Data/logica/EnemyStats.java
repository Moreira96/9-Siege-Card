...
public class EnemyStats implements Serializable {
    ...
    public int getPosicao (String qual)
    {
            ...
            for( int i =  0 ; i  < trebuchet.length; i++)
        {
            ...
            System.out.println(" TREBUCHET INDEX : .>" + index);
            return index;
        }
        else
        ...
        if(qual.toLowerCase().equals("door"))
        {
           int index  = 0;
            for( int i =  0 ; i  < door.length; i++)
        {
            ...
            System.out.println("DOOR INDEX : .>" + index);
            return index;  
        }
        else
        if(qual.toLowerCase().equals("tower"))
        {
           int index  = 0;
            for( int i =  0 ; i  < tower.length; i++)
        {
            ...
            System.out.println("TOWER INDEX : .>" + index);
            return index;  
        }
        else
